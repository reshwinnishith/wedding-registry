...
/**
 * The real gift list, pulled from the couple's own wishlist doc.
 * Edit freely, then run `npm run seed` to (re)write these to
 * Firestore. Re-running the seed script only touches gifts whose id
 * is unchanged and not yet claimed; see scripts/seed.mjs.
 */
